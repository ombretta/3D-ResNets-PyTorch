...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 11 15:54:59 2021
...
annotation_path = 'CV-DataSets/breakfast/breakfast.json'
# Used dataset (activitynet | kinetics | ucf101 | hmdb51 | breakfast)
dataset = 'breakfast'
...
if root_path: text += " --root_path=/tudelft.net/staff-bulk/ewi/insy/" 
text += " --video_path=CV-DataSets/breakfast/"
